...
// customStyle.textContent = applyUpdate.loadSettings();
...
//     else if (request.action === "messageColorUserStyle")
//         updateMessageColorUser(request.arg);
//     else if (request.action === "messageColorNonUserStyle")
//         updateMessageColorChatGPT(request.arg);
//     else if (request.action === "textColorUserStyle")
//         updateTextColorStyle(request.arg, true);
//     else if (request.action === "textColorNonUserStyle")
//         updateTextColorStyle(request.arg, false);
//     else if (request.action === "restoreUserSettings") loadSettings();
//     else if (request.action === "restoreDefaultSettings") setDefaultSettings();
// });
...
// customStyle.textContent = applyUpdate.setDefaultSettings();
